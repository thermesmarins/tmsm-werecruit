...
?><select
	aria-label="<?php esc_attr( _e( $atts['aria'], 'tmsm-werecruit' ) ); ?>"
...
if ( ! empty( $atts['blank'] ) ) {
	...
	?><option value><?php esc_html_e( $atts['blank'], 'tmsm-werecruit' ); ?></option><?php
...
foreach ( $atts['selections'] as $selection ) {
	...
	?><option
		...
		esc_html_e( $label, 'tmsm-werecruit' );
...
?></select>
<span class="description"><?php esc_html_e( $atts['description'], 'tmsm-werecruit' ); ?></span>
</label>
